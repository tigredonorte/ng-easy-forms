...
var NgEasyFormsModule = /** @class */ (function () {
    ...
    NgEasyFormsModule.decorators = [
        { type: core_1.NgModule, args: [{
                    imports: [common_1.CommonModule, email_field_module_1.EmailFieldModule, password_field_module_1.PasswordFieldModule, save_button_module_1.SaveButtonModule, toggle_field_module_1.ToggleFieldModule],
                    declarations: [],
                    exports: [email_field_module_1.EmailFieldModule, password_field_module_1.PasswordFieldModule, save_button_module_1.SaveButtonModule, toggle_field_module_1.ToggleFieldModule]
                },] },
    ];
    /** @nocollapse */
